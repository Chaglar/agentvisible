...
(function (root) {
  ...
  var SUGGESTED = [
    ...
    { id: 'mag', title: 'A science magazine', author: 'Nat Geo Kids, Aquila, or old Double Helix', tag: 'magazine',
      kid: 'Short articles, experiments, puzzles. Read the bits you want.',
      why: 'The NAPLAN Year 3 reading test is a magazine of mixed short texts, so a real magazine is the closest thing to practising it without it feeling like practice. Note: CSIRO stopped publishing Double Helix in June 2025 — back issues are still excellent and libraries hold them, but for a live subscription use National Geographic Kids (6-14) or Aquila (8-12).' },
