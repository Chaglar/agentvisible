        ...
        <div className="prose prose-invert prose-lg max-w-none">
          <div className="space-y-8">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-3 text-gray-dark-200">Automatically Collected Information</h3>
              ...
              <h3 className="text-xl font-semibold mb-3 mt-6 text-gray-dark-200">Voluntarily Provided Information</h3>
              <ul className="list-disc list-inside text-gray-dark-300 space-y-2 ml-4">
            ...
            <section>
              ...
              <p className="text-gray-dark-300 leading-relaxed mt-4">
                Contact us at <a href="mailto:privacy@agentvisible.ai" className="text-accent hover:text-secondary">privacy@agentvisible.ai</a> to exercise these rights.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-dark-300">
                <p>Email: <a href="mailto:privacy@agentvisible.ai" className="text-accent hover:text-secondary">privacy@agentvisible.ai</a></p>
                <p className="mt-2">
                  AgentVisible<br />
                  Privacy Officer<br />
